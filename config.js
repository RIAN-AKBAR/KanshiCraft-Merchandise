...
const KANSHI_CONFIG = {
    ...
    TUTORIAL_STEPS: [
        { number: 1, icon: "fa-hand-pointer", title: "Pilih Produk", description: "Klik tombol 'Beli' pada produk yang kamu inginkan." },
        ...
        { number: 4, icon: "fa-telegram", title: "Kirim ke Telegram", description: "Klik 'Buka Telegram & Tempel' → paste pesan di DM." }
    ],
    ...
    getMessageTemplate: function(product) {
        ...
        else if (product.category === "Give & Merchandise") categoryLabel = "🎁 Give & Merchandise";
        else if (product.category === "Live Streaming") categoryLabel = "🎥 Live Streaming";
        else if (product.category === "Stiker") categoryLabel = "🏷️ Stiker";
...
const KANSHI_CONFIG = {
    ...
    INSTAGRAM_URL: "https://www.instagram.com/kroketfun.zy?igsh=aWh3dGNkazRobzB4",
    INSTAGRAM_DIRECT_ID: "17843367183524675",
    TELEGRAM_USERNAME: "@kroketfun",  // 👈 GANTI DENGAN USERNAME TELEGRAM KAMU
    EMAIL: "rian032008@gmail.com",
    ...
    PRODUCTS: [
        ...
        },
        {
            ...
            price: "Rp 275.000",
            category: "boneka",
            img: "https://placehold.co/500x500?text=Boneka+Bakugou",  // 👈 GANTI DENGAN URL GAMBAR ASLI
            stock: 5,
            isAvailable: true,
            shippingEstimate: "3-5 hari kerja"
        },
        {
            ...
            price: "Rp 80.000 - 100.000",
            category: "Fanart",
            img: "https://placehold.co/500x500?text=PNGtuber",  // 👈 GANTI DENGAN URL GAMBAR ASLI
            stock: 5,
            isAvailable: true,
            shippingEstimate: "7-14 hari kerja"
        },
        {
            id: 4,  // 👈 ID DIPERBAIKI (dari 3 jadi 4)
            name: "YCH Stiker",
            desc: "S&K YCH STIKER\n\n1. DP 50% di awal, lunas 50% sebelum file dikirim. DP tidak refund jika pesanan dibatalkan klien.\n2. Tidak ada revisi karena base sudah disediakan.\n3. Pengerjaan 5-7 hari kerja (tergantung antrian).\n4. File diberikan dalam format PNG melalui drive.",
            price: "Rp 50.000",
            category: "aksesoris",
            img: "https://placehold.co/500x500?text=YCH+Stiker",  // 👈 GANTI DENGAN URL GAMBAR ASLI
            stock: 5,
            isAvailable: true,
            shippingEstimate: "5-7 hari kerja"
        }
    ...
    // ========== FUNGSI PEMBUAT PESAN (PESAN KE IG & TELEGRAM) ==========
    getMessageTemplate: function(product) {
        const date = new Date().toLocaleDateString('id-ID', { 
            year: 'numeric', 
            month: 'long', 
        ...
        // Mapping kategori (UPDATE dengan kategori baru)
        let categoryLabel = "🎨 Lukisan/Ilustrasi";
        if (product.category === "boneka") categoryLabel = "🧸 Boneka Tangan";
        else if (product.category === "aksesoris") categoryLabel = "💍 Aksesoris";
        else if (product.category === "Fanart") categoryLabel = "🎨 Custom Fanart / Digital";
